...
![Telegram Channel](https://img.shields.io/badge/Telegram-%40avaco__cloud-26A5E4?style=for-the-badge&logo=telegram&logoColor=white)
...
└──────────┘                        └──────────────┘            └──────────────┘
```
کلاینت با SNI=`vercel.com` به دامنه‌ی Vercel وصل می‌شه. برای سانسورچی شبیه ترافیک عادی Vercel به‌نظر می‌رسه.
Vercel Serverless Function بدنه‌ی request رو stream می‌کنه به سرور Xray.
پاسخ هم به همون صورت stream می‌شه برمی‌گرده.
---
محدودیت‌ها و هشدارها
...
روی دامنه‌ت کلیک کن → منوی DNS → Records
Add record:
فیلد	مقدار
Type	`A`
...
login: `root` + Enter، رمز رو وارد کن
...
در صفحه‌ی تنظیمات، بخش Environment Variables:
...
<div align="center">
![Join Telegram](https://img.shields.io/badge/%D9%87%D9%85%D8%B1%D8%A7%D9%87%20%D9%85%D8%A7%20%D8%B4%D9%88-Avaco%20Cloud-26A5E4?style=for-the-badge&logo=telegram&logoColor=white)
